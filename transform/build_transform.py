...
from .flow_augmentation import WindowSlicing, NoiseInjection, MaskAug, DropAug, RRPAug
...
def build_flow_transform(args):

    train_transform = NoiseInjection(0.05, args.size)
